...
#region Genaric methods


// Logger.Execute<int>(34);
// Logger.Execute<Entry>(new Entry() { Data = "JSON"});
...
#region Genaric nethods constrains
...
#region Genaric constaints types
...
// --------- 2. Обычный (необобщенный) наследник -----------
...
// --------- 3. Обобщенный наследник с собственым типом ------


// public class Archer<T> : Unit<Identity>
// {
